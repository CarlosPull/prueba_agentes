...
2. **EVALUACIÓN POR SUBAGENTE ANALISTA Y BLOQUEO DE RE-DESPACHO**:
   ...
   - El Orquestador leerá ese rechazo terminal, concluirá el reporte en `REPORTE_PI.md` y **ESTÁ TERMINANTEMENTE PROHIBIDO INVOCAR A CUALQUIER OTRO AGENTE O HERRAMIENTA**.
...
4. **Fallo Cerrado de Sincronización**: Si el fetch, la extracción o la validación falla, no se ejecuta Pi ni se sustituye silenciosamente la versión ya activa.
